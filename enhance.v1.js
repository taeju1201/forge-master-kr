(function enhanceFactory(){
  ...
  async function skinsV2(){
    ...
    function skinSprite(s){let idx=map?.skins?.mapping?.[s.SkinId.Type+'_'+s.SkinId.Idx];return idx==null?'':spriteStyle(`${GTEX}/${map.skins.texture}`,idx,map.skins.grid.columns,map.skins.sprite_size.width,72)}
